...
import com.jks.userrecognitionandaccesspermission.models.UserItemtwo
import kotlinx.android.synthetic.main.each_row_alladmin_list.view.*


class SearchAdapter(val context: Context, val list:List<UserItemtwo>, val listener:SentRequestListener, val currentUid:String, val seefeedlistener: seefeedlistener) : RecyclerView.Adapter<SearchAdapter.ListOfAdminViewHolder>() {
